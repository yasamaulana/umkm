...
@section('isi')
    <main id="main" class="main">
        ...
        <div class="card rounded">
            <h4 class="card-title text-center">Data Admin Website</h4>
            <div class="container">
                        ...
                        <div class="modal fade" id="edit{{ $isi->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ url('/data-admin/' . $isi->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                ...
                <div class="modal-content">
                    <form action="{{ url('/data-admin') }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="form" class="form-label">Alamat</label>
                                <input type="text" class="form-control" name="alamat" id="form" required>
                            </div>
                            <div class="mb-3">
                                <label for="form" class="form-label">Nomor</label>
                                <input type="number" class="form-control" name="nomor" id="form" required>
                            </div>
                            <div class="mb-3">
                                <label for="form" class="form-label">Email</label>
                                <input type="email" class="form-control" name="email" id="form" required>
                            </div>
                            <div class="mb-3">
                                <label for="form" class="form-label">Password</label>
                                <input type="password" class="form-control" name="password" id="form" required>
                            </div>
